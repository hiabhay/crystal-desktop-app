...
import CollatedNailsList from "./CollatedNailsList";
import ProductsTemp from "../assets/ProductsTemp.png";
import Section from "../components/Section";
import DetailsHeader from "./DetailsHeader";
import Footer from "../components/Footer";

const CollatedNailsDetails = () => {
  const { id } = useParams();

  const selectedItem = CollatedNailsList.find(
    (item) => item.id === parseInt(id, 7)
  );
      ...
      <Section>
        <div className="pl-32 pb-16 sm:pl-0">
          <div className="flex sm:flex-col">
            ...
            <div className="w-[250px] h-[250px] sm:w-[200px] sm:h-[200px] border-2 border-gray-400">
            <img src={selectedItem.img} alt={selectedItem.name} className="w-[250px] h-[220px] sm:w-[200px] sm:h-[180px]"/>
            </div>
...
export default CollatedNailsDetails;